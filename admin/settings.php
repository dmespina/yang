    ...
    <div class="d-flex">
        ...
        <nav id="sidebar" class="bg-dark p-3 sidebar">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="settings.php" class="nav-link text-white active"><i class="bi bi-gear"></i> Settings</a></li>
        ...
        <!-- Main Content -->
        <div class="flex-fill p-4" id="content" style="max-width: 1500px; width: 100%; margin: 0 auto; padding: 20px; min-height: 80vh;">
    <div class="container mt-5">
        <form method="post"
              class="shadow p-4 form-w bg-white rounded" 
